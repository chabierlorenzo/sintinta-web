...
const DescriptionCmp: React.FC = ({ children }) => {
  ...
  const sectionNumber =
    "flex w-16 h-16 mx-auto items-center justify-center text-2xl font-bold font-heading rounded-full bg-blue-50 text-sky-600";
        ...
        <div className="flex flex-wrap -mx-8">
          <div className="w-full lg:w-1/2 px-8">
            <div className="mb-12 lg:mb-0 pb-12 lg:pb-0 border-b lg:border-b-0">
              <h2 className={title}>Slow reading</h2>
              <p className="mb-8 leading-loose text-gray-500">
                Slow reading is the intentional reduction in the speed of
                reading, carried out to increase comprehension or pleasure. The
                concept appears to have originated in the study of philosophy
                and literature as a technique to more fully comprehend and
                appreciate a complex text
              </p>
          ...
          <div className="w-full lg:w-1/2 px-8">
            <ul className="space-y-12">
              <li className="flex -mx-4">
                ...
                <div className="px-4">
                  <h3 className="my-4 text-xl font-semibold text-gray-900">
              ...
              <li className="flex -mx-4">
                ...
                <div className="px-4">
                  ...
                  <p className="text-gray-500 leading-loose">
                    Share your emotions and knowledge with other readers to
                    enrich all the content and knowledge you have been creating.
                    Find the relationships. Build your reading.
                  </p>
                </div>
              </li>
            </ul>

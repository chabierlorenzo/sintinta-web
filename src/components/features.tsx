...
const FeaturesCmp: React.FC = ({ children }) => (
  <div className="container bg-white bg-opacity-80 dark:bg-gray-800">
    <div className="mb-16 text-center">
      <p className="text-base text-indigo-600 tracking-wide mt-16">
        Slow reading:{" "}
        <span className="text-black">
          Slow reading is the intentional reduction in the speed of reading,
          carried out to increase comprehension or pleasure. The concept appears
          to have originated in the study of philosophy and literature as a
          technique to more fully comprehend and appreciate a complex text
        </span>
      </p>
    </div>
    <div className="flex flex-wrap my-12 dark:text-white">
      <div className="w-full border-b md:w-1/2 md:border-r lg:w-1/3 p-8">
        ...
        <p className="leading-loose text-gray-500 dark:text-gray-200 text-md">
          Receive more sales by selling across multple sales channels instead of
          just having a single point of entry.
        </p>
      </div>
      ...
      <div className="w-full md:w-1/2 lg:w-1/3 p-8">
        ...
        <p className="leading-loose text-gray-500 dark:text-gray-200 text-md">
          Build unique product titles and descriptions instead of spending days
